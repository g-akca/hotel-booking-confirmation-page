  ...
  return (
    <div 
      className="
        ...
        relative z-10 rotate-2 p-6 rounded-[20px] text-sun-50 flex flex-col gap-5 justify-between
        shadow-[0_10px_40px_rgba(194,90,46,0.35),0_50px_80px_rgba(169,66,31,0.25)] tablet:order-2 tablet:rotate-4
      "
    >
